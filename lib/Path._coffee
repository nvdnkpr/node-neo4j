...
module.exports = class Path
    ...
    #
    # @property start {Node} The node that this path starts at.
    #
    get start: -> @_start || null

    #
    # @property end {Node} The node that this path ends at.
    #
    get end: -> @_end || null

    #
    # @property length {Number} The length of this path.
    #
    get length: -> @_length || 0

    #
    # @property nodes {Array<Node>} The nodes that make up this path.
    #
    get nodes: -> @_nodes || []

    #
    # @property relationships {Array<Relationship>} The relationships that
    #   make up this path.
    #
