...
module.exports = class PropertyContainer
    ...
    #
    # @property self {String} The URL of this property container.
    #
    ...
    #
    # @property exists {Boolean} Whether this property container exists in
    #   (has been persisted to) the Neo4j database.
    #
    get exists: -> @self?

    #
    # @property id {Number} If this property container exists, its Neo4j
    #   integer ID.
    #
    get id: ->
        if not @exists
    ...
    #
    # @property data {Object} Get or set this property container's
    #   properties. This is a map of key-value pairs.
    #
